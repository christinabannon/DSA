 ...
 * Status: This driver is similar to the p3 driver, however this one should
 * 	be able to handle returning the proper index for what a number should be
...
public class AOSL2Driver
{
	...
	public static void main(String []args) 
			throws IOException
	{
		//CB AOSL2 = AscendinglyOrderedStringList(attempt)2
		AOSL2
		array = new AOSL2();
