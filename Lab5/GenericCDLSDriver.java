...
public class GenericCDLSDriver 
...
new BufferedReader(new InputStreamReader(System.in));
	...
	public static void main(String[] args)
			throws IOException 
	{
		GenericCDLS list = new GenericCDLS();
	...
	public static GenericCDLS case1(GenericCDLS list) 
			throws IOException
	{
	...
	public static GenericCDLS case2(GenericCDLS list) 
			throws IOException
	{
	...
	public static GenericCDLS case3(GenericCDLS list) 
			throws IOException
	{
	...
	public static GenericCDLS case4(GenericCDLS list)
	{
		list.removeAll();
	...
	public static void case5(GenericCDLS list)
	{
		if (!list.isEmpty()) {
	...
	public static GenericCDLS case6(GenericCDLS list)
	{
		if (!list.isEmpty()) {
			
			GenericCDLS newList = new GenericCDLS();
